...
const sims = <Sim>[
  Sim(
      ...
      limitPalevo: [true, false, false, false, false, false],
      lac: '3211',
      cell: '18442',
      imei: '35782000112233',
  ...
  Sim(
      ...
      spec: 'NO',
      io: 'O',
      // SOU: this call is classified internal SIM-to-SIM by the same dialplan
      // branch that encodes the #SOU<imsi> suffix in `numberb` below — the
      // two must be set together, they're not independent fields.
      qos: 'SOU',
      napr: 'SS',
      plan: 'default',
      nabor: 'mts_spb',
      ...
      liveState: 'ring',
      elapsedSec: 6,
      numberb: '89261112233#SOU250020112233445',
      limits: ['0/9000', '0/9000', '0/9000', '0/9000', '0/9000', '0/9000'],
      lac: '—',
      cell: '—',
      imei: '86234500019955',
      imeiWarn: true,
  ...
  Sim(
      ...
      limitPalevo: [false, false, false, true, false, false],
      lac: '5510',
      cell: '22114',
      imei: '35782000998877',
  ...
  Sim(
      ...
      pdd1: 2,
      pri: 5,
      limits: ['300/9000', '0/9000', '0/9000', '0/9000', '0/9000', '0/9000'],
      lac: '4408',
      cell: '9944',
      imei: '35782000445566',
  ...
  Sim(
      ...
      elapsedSec: 8,
      cooldownMax: 120,
      limits: ['900/9000', '0/9000', '0/9000', '0/9000', '0/9000', '0/9000'],
      lac: '1201',
      cell: '4488',
      imei: '35782000778899',
  ...
  Sim(
      ...
      pdd1: 2.6,
      pri: 2,
      limits: ['80/9000', '0/9000', '0/9000', '0/9000', '0/9000', '0/9000'],
      lac: '7702',
      cell: '3311',
      imei: '86234500022233',
