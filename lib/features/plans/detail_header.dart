      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          PopupMenuButton<String>(
            ...
            icon: const FugueIcon('ui-menu.png', semanticLabel: 'Действия с планом'),
            itemBuilder: (_) => [
        ...
        Wrap(spacing: 12, runSpacing: 8, crossAxisAlignment: WrapCrossAlignment.center, children: [
          ...
          _ProTagField(
            ...
            value: plan.proTag,
            onChanged: (v) => controller.updateIdentity(proTag: v, clearProTag: v == null),
          ),
          Text('используется ${controller.usageCount(plan.id)} симками', style: T.cellSub),
        ]),
      ]),
    );
  }
