  ...
  Widget build(BuildContext context) {
    ...
    if (controller.loadState == PlanLoadState.error) {
      return Center(
        ...
        Text(controller.errorMessage ?? 'Не удалось загрузить планы.',
            style: T.body),
        const SizedBox(height: 8),
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      Padding(
        ...
        child: Row(children: [
          ...
          if (!controller.explanationOpen)
            ExplanationReopenButton(controller: controller),
        ]),
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        PlanDetailHeader(
            controller: controller, commandSets: commandSets, narrow: narrow),
        Expanded(
