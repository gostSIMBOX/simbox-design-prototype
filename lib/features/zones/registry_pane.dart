        ...
        child: Row(children: [
                ...
                items: [
                  for (final zone in controller.records)
                    DropdownMenuItem(
                        value: zone.id,
                        child:
                            Text(zone.name, overflow: TextOverflow.ellipsis)),
                ],
                onChanged: (id) {
          ...
          IconButton(
            ...
            icon: const FugueIcon('application--plus.png',
                semanticLabel: 'Добавить направление'),
          ),
        ]),
      );
    }
          ...
          child: controller.visibleZones.isEmpty
              ? const Center(
                  child: Padding(
                      ...
                      child: Text('Направления не найдены', style: T.caption)))
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Material(
                      ...
                      child: InkWell(
                        onTap: () =>
                            requestZoneSelection(context, controller, zone.id),
                        child: Container(
                                ...
                                Expanded(
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            '${zone.id}${zone.region != null ? ' · ${zone.region}' : ''}',
                                            maxLines: 1,
                                            overflow: TextOverflow.ellipsis,
                                            style: T.cellSub),
                                      ]),
