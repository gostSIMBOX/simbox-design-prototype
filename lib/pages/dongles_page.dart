...
class _DonglesPageState extends State<DonglesPage> {
  ...
  Widget _dongleActions(AppState st) => Panel(
  ...
  Widget _pinActions(AppState st) => Panel(
  ...
  Widget _modesActions(AppState st) => Panel(
  ...
  List<ActionGroup> _groups(AppState st) => [
        ActionGroup(
            ...
            icon: 'dongle.png',
            builder: (_) => _dongleActions(st)),
        ActionGroup(
            key: 'pin',
            label: 'PIN и разблокировка',
            icon: 'lock.png',
            builder: (_) => _pinActions(st)),
        ActionGroup(
            key: 'modes',
            label: 'Режимы и AT-команда',
            icon: 'conn.png',
            builder: (_) => _modesActions(st)),
      ];
